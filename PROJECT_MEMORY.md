...
- [2026-07-14] Patch archive and baseline
  Value: `/home/l30002999/huawei-cilium-v1.19.1` targets upstream Cilium v1.12.19 commit `a1d7fbd43b563c809330b1c3e28165a3e7ff43aa`. Per the corrected delivery requirement, the earliest 14 functional patches remain separate and later validation bug fixes/tests are consolidated in `0015-fix-huaweicloud-consolidate-validation-bug-fixes.patch`; `series` and the directory both contain exactly 15 patches. Audit92 clean replay commit `4e8bb5679e31266405566a9a128eb941265b5e8d`, patch-generation commit `cecd65a10ecba97c47f8705f8dda839e8daf62a5`, and authoritative source `12b37635d79acd25949b4926b61329f5f519513c` share tree `591aa02eb2826b5d2101e7de468d2907fefd4092`; patch 0015 SHA256 is `2436c9604202914edc4c66584cc89b1be2fe0cd87f203b317f850000a988e9c1`. The latest patch/evidence changes remain local until the user explicitly requests another push.
...
- Last verified: The ledger contains 393 Pass, 53 Pending, 5 approved Skip, and 0 recorded Fail. Audit90 added bounded Create HTTP-timeout coverage and fixed fail-fast validation for unsafe endpoint/region/project configuration; the rebuilt audit90 Operator remains live 1/1 Ready/restart0. Audit91 proved external Secret identity/data/ownership remain unchanged across real isolated Helm lifecycle. Audit92 proved request-ID safety and real invalid-SG fail-closed behavior after safely freeing one unused quota slot; recovery restored exact cloud/CiliumNode state. Audit93 proved isolated cloud API network and DNS failures are attributable without disturbing production. Audit94 freshly reran real production-client delete/single-create+inline-tag+Show/List/delete/batch-create+tag+Show/List/delete/replenish in strict order, then proved exact cloud/CiliumNode set recovery, pool40, used-outside0, error0, no residue, and mesh56/56. Audit90 Operator and audit64 Agents are authoritative. Metadata-only IPv4 and physically truncated skb remain Pending rather than overclaimed. Literal 40-Pod cases remain Pending rather than being folded into the approved min-allocate environment Skip.
