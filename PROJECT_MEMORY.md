...
- Immediate live step: preserve the verified audit59 baseline and execute the next isolated Pending P0/P1 recovery or fault-injection row; serialize all destructive/customer suites with the shared lock.
