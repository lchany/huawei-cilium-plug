...
- [2026-07-14] Patch archive and baseline
  Value: `/home/l30002999/huawei-cilium-v1.19.1` targets upstream Cilium v1.12.19 commit `a1d7fbd43b563c809330b1c3e28165a3e7ff43aa`. Per the corrected delivery requirement, the earliest 14 functional patches remain separate and later validation bug fixes/tests are consolidated in `0015-fix-huaweicloud-consolidate-validation-bug-fixes.patch`; `series` and the directory both contain exactly 15 patches. Audit98 clean replay commit `485db52ed8038161db8c33b233f68fe89f7742dc`, patch-generation commit `b6f03b494412ef218b0a110a0af43e89fcbf2c12`, and authoritative source `74de651a7adb763ef9ad3b05e5b06206c57ce585` share tree `24d9e81b614f4a4309cfaa964e5efc11f9dbef58`; patch 0015 SHA256 is `9c63bc0d35b067295e5fabe4c0eabf688d06332a9e9adfaed9ab574dfe4619bd`. The latest patch/evidence changes remain local until the user explicitly requests another push.
...
- Last verified: The ledger contains 399 Pass, 42 Pending, 10 user-approved Skip, and 0 recorded Fail. Audit90 Operator remains live 1/1. Audit95 fixed the unsupported HuaweiCloud IPv6 boundary, rolled deterministic Agent+BPF images to all five nodes, and passed complete customer regression. Audit96 proved isolation under a 1000-Event backlog. Audit97 added real kernel BPF coverage for metadata-only IPv4 and VLAN/MAC mismatches. Audit98 executed a real 17-byte skb with a VLAN header truncated by one byte; focused 20-repeat, full eight-object, clean replay, and post-test mesh passed. Runtime product/BPF code was unchanged by audits97-98, so audit95 Agents and audit90 Operator remain authoritative; audit64 Agent is retained as rollback. The user approved skipping STAB-01 through STAB-04 and BRACE-12 rather than waiting for 24/72-hour or equivalent long-idle stability runs. Literal 40-Pod cases remain Pending rather than being folded into the approved min-allocate environment Skip.
