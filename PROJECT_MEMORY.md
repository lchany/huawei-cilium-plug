...
- Last verified: The ledger contains 331 Pass, 116 Pending, 4 approved Skip, and 0 recorded Fail. Independent review rejected audit62's narrow route-recovery conclusion after finding empty per-VLAN tables and a missing permanent neighbor despite successful main-table traffic. Audit64 adds non-mutating ordinary-endpoint plus `cilium_host` router reconciliation and passed drift, three real trunk flaps, five-node rollout, ten recreate rounds, complete customer regression, exact map ownership, routes/neighbors, and final audit. Its clean replay/tree/patch identities are `c5b51a316fc945163b5f9b65c8634f0e14c847ad`, `99bf4f10a82852390846d1b0cc74d0f45527b334`, and patch SHA256 `38338f0326ce862c12b8896591deb6e859ba85c2d2c95cdade19f161338b9702`; Agent SHA256 is `a7b00205e414e0c767ed8ee9ac2df0ff398fb3df4ea147c28b877a99051a446a`, manifest `sha256:86c241725764df7a68de4df3e5919e021fc4f64b70b6147fdfa66ae12560366c`. Audits65-67 verified foreign/legacy rule isolation, audit64→audit60→audit64 rollback, mixed versions, same-tag new digest, explicit ImagePullBackOff isolation, and recovery. Audit68 verified real worker cordon/drain/uncordon plus Agent recreation under a temporary NoSchedule taint with no residue. Audit69 scaled Operator 1→2, deleted the active Lease holder, observed standby takeover and 2/2 recovery, then safely returned to one replica with a second Lease transition; customer traffic and final mesh remained healthy. Audit60 remains the rollback image.
