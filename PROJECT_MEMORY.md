...
- Last verified: The ledger contains 334 Pass, 112 Pending, 5 approved Skip, and 0 recorded Fail. Audit70 completed exact three-by-five-minute same-node and same-AZ cross-node TCP streams, three-run high-resolution TCP/UDP/ICMP latency, twenty Pod delete-to-Ready samples with CNI/IPAM and image-cache phase evidence, and three-stage Agent/Operator resource sampling. Cross-node sustained TCP median was 1405.31 Mbps with 3.238% maximum deviation; all TCP/UDP RTT exchanges had zero loss. Pod Ready P50/P95/P99 was 3998/4039/4084 ms, Scheduled-to-Cilium request P50/P95 was 344/354 ms, and all images were cache hits. Component CPU remained 1.707–2.799 mcore with at most 2.04 MiB within-phase memory change. Final mesh was 56/56, five audit64 Agents retained the exact hash with zero restarts, and Operator remained 1/1. PERF-03 is the fifth user-approved cross-AZ Skip; PERF-01 awaits the retained audit60 baseline comparison. Audit64 source/replay/tree/patch and runtime identities remain unchanged, and audit60 remains the rollback image.
...
- Immediate live step: roll all five Agents to retained audit60 as an old-candidate performance baseline, repeat RTT and three-by-five-minute streams, then restore audit64 sequentially and require per-node mesh plus final identity/route/health audit before closing PERF-01.
