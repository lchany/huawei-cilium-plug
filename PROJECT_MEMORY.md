...
- [2026-07-14] Patch archive and baseline
  Value: `/home/l30002999/huawei-cilium-v1.19.1` targets upstream Cilium v1.12.19 commit `a1d7fbd43b563c809330b1c3e28165a3e7ff43aa`. Per the corrected delivery requirement, the earliest 14 functional patches remain separate and later validation bug fixes/tests are consolidated in `0015-fix-huaweicloud-consolidate-validation-bug-fixes.patch`; `series` and the directory both contain exactly 15 patches. Audit87 clean replay commit `5a769b24151edfa10884c63fa2c4871d353b4321`, patch-generation commit `596cd3a1366b8e9e2451e3857ba9f0a2089f7339`, and authoritative source `2752f1f1a5a9088a9cb7e0d3d8b55928d998facf` share tree `5deb2c9a650a0936d532a5aa67c66a87828496d9`; patch 0015 SHA256 is `b84beacad977604f5ef431234abdc267e40388086df63e81151472ef96b1323e`. The latest patch/evidence changes remain local until the user explicitly requests another push.
...
- Last verified: The ledger contains 379 Pass, 67 Pending, 5 approved Skip, and 0 recorded Fail. Audit86 independently rechecked cleanup after 1801 seconds: five Nodes/Agents and one audit81 Operator healthy with restart zero, pool40/used-outside0/errors0, no temporary residue, all independent route tables/permanent neighbors complete, and mesh 56/56. Audit87 added exact empty/special subnet-tag value coverage; targeted 100/race20, full ENI and HuaweiCloud ordinary/race ten-round suites, vet, regenerated 15-patch replay, and tree identity all passed. Authoritative runtime product code did not change, so audit81 Operator/audit64 Agent remain deployed. Metadata-only IPv4 and physically truncated skb remain Pending rather than overclaimed. Literal 40-Pod cases remain Pending rather than being folded into the approved min-allocate environment Skip. Audit60 remains the rollback Agent image; audit20 and audit76 remain retained Operator rollback references.
