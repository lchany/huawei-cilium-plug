...
- [2026-07-14] Patch archive and baseline
  Value: `/home/l30002999/huawei-cilium-v1.19.1` targets upstream Cilium v1.12.19 commit `a1d7fbd43b563c809330b1c3e28165a3e7ff43aa`. Per the corrected delivery requirement, the earliest 14 functional patches remain separate and later validation bug fixes are consolidated in `0015-fix-huaweicloud-consolidate-validation-bug-fixes.patch`; `series` and the directory both contain exactly 15 patches. Audit76 clean replay commit `578619ee1c8424f10a6e414052f623a29af8b016` and authoritative source `1bc1ec0a096347e3d0d5eb3b48708800cf3e6b42` share tree `f0a68079a7b712b536542c361fd5ce70bbe6cabf`; patch 0015 SHA256 is `f8d2f08c3a83cdde1ff6a53f970714c66213e81612b08d7695108ec6b66e894a`. The latest patch/evidence changes remain local until the user explicitly requests another push.
...
- Last verified: The ledger contains 351 Pass, 95 Pending, 5 approved Skip, and 0 recorded Fail. Audit79 injected invalid AK/SK through the referenced Secret and restarted Operator: the cloud auth failure was diagnostic while mesh remained 56/56 and the exact pool/resource map stayed unchanged; restoring the remotely protected Secret and restarting returned auth/severe matches to zero, five CiliumNode errors empty, strategy 1/1, audit76 Ready/restart0, and removed the backup. Generic Pod readiness remained true during invalid credentials and must not be used as cloud-auth proof. Audit78, audit77, and audit76 evidence remains valid. Five nodes, five exact audit64 Agents, Operator audit76, 40 pool entries, routes, neighbors, and logs are healthy. Literal 40-Pod cases remain Pending rather than being silently folded into the approved min-allocate environment Skip. Audit60 remains the rollback Agent image and audit20 remains the rollback Operator image.
